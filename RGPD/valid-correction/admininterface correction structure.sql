...
INSERT INTO `users` (`id`, `pseudo`, `email`, `pwd`, `address`, `postal_code`, `city`, `firstname`, `lastname`, `birthday`, `eyes_color`, `size`, `weight`, `animal_name`, `last_login`, `anonymized`, `role_id`) VALUES
(1, 'admin', 'admin', '$2y$10$lzN7XznuCUXxCrriWj13a.0c0S9rZ8ZBkXbpVHmz39ZeIgkoYfzRC', '42 Rue omega', 34000, 'Montpellier', 'admini', 'strateur', '1990-06-05', 'marron', '167.2', '70', NULL, '2024-08-12', 0, 1);
-- --------------------------------------------------------
...
ALTER TABLE `user_archive`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_archive_users_FK` (`user_id`);
